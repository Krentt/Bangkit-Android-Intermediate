...
class SignupActivity : AppCompatActivity() {
    ...
    private fun playAnimation(){
        ...
        val namaInput = ObjectAnimator.ofFloat(binding.nameEditTextLayout, View.ALPHA, 1F).setDuration(500)
        ...
        AnimatorSet().apply {
            playSequentially(title, nama, namaInput, email, emailInput, password, passwordInput, button)
            start()
        }
    }
